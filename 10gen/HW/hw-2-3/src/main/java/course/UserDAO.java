...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
        ...
        DBObject newUser = new BasicDBObject("_id", username).append("password", passwordHash);
    ...
    public DBObject validateLogin(String username, String password) {
        ...
        DBObject searchUser = new BasicDBObject("_id", username);
        user = usersCollection.findOne(searchUser);
