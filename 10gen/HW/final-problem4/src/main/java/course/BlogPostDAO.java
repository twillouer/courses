...
public class BlogPostDAO {
	...
	// changes to templates and post retrieval code.
        ...
        if (post != null) {
            DBObject increment = new BasicDBObject("$inc", new BasicDBObject("comments."+ordinal+".num_likes", 1));
            postsCollection.update(new BasicDBObject("permalink", permalink), increment);
        }
    }
}
