...
public class BlogPostDAO {
    ...
    public void addPostComment(final String name, final String email, final String body,
        ...
        if (post != null) {
            ...
            postsCollection.update(new BasicDBObject("permalink", permalink), new BasicDBObject("$push", new BasicDBObject("comments", comment)), false, false);
        }
